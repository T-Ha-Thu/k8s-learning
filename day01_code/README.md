...
Today I want to share the Day 1 of #40DaysOfKubernetes journey with #Piyushsachdeva .  
Below are the lecture of Day 1 learning.  

1)What is Docker?  
2)Understanding Containers VS Virtual Machines.  
3)Containers VS Virtual Machines with the help of a Building and House analogy.  
4)Challenges with the non-containerized applications.  
5)How Docker solves the challenges?  
6)Simple Docker WorkFlow.  
<img width="1027" height="712" alt="simpledockerflow" src="https://github.com/user-attachments/assets/afe4a4ed-16db-4f36-9100-822d29144502" />  
7)Docker Architecture  
<img width="1232" height="551" alt="dockerarchitecture" src="https://github.com/user-attachments/assets/4e25e0f7-08af-4b29-97f1-ba9180d123a6" />  
